...
Introduction to Python Programming} \comment{(5 weeks)}
...
\item<4-> Find resources to solve specific issues
\end{enumerate}

\vspace{.5cm}

\onslide<5->{\textbf{What we won't do:}\\
...
\faLink~\href{../notebooks/Intro/teacher-map.ipynb}{teacher-map}
