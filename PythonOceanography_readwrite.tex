...
\item[\faGears] text representation of a netCDF dataset (header information, variables, \ldots)
\end{description}
...
\item[\faGears] visualization and analysis environment
\end{description}
...
\item[\faGears] quick visualisation of 3-4D fields
\end{description}
...
\item[\faGears] interactive graphical display
\end{description}
...
\item[\faGears] plot, slice, combine, overlay, \ldots
\end{description}
...
\item[\faGears] manipulate (merging, averaging) netCDF files (+other formats)
\item[Examples:] 
\begin{itemize}
...
\item[\faGears] command line operations on netCDF files
...
\item[\faGears] interactive exploration, analysis and visualization of oceanographic data
\end{description}
